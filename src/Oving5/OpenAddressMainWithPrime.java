...
public class OpenAddressMainWithPrime {
    public static void main(String[] args) {
        ...
        System.out.println("Time linear probing with prime table length: " + (end-start)/1000000 + " ms");
        ...
        System.out.println("Time quadratic probing with prime table length: " + (end2-start2)/1000000 + " ms");
        ...
        System.out.println("Time Double hashing with prime table length: " + (end3-start3)/1000000 + " ms");
